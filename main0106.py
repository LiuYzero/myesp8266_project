...
def draw_rectangle(x, y, length, width, isFill=0, isProcess=0):
    '''
    绘制矩形
    :param: x y 矩形左上角
    :param: length width 长和宽
    :isFill: 是否填充 0 否 1 是
    :isProcess: 是否显示为进度条 无用
    :return: None
    '''
    ...
    draw_line(point_upper_left[0], point_upper_left[1],
              point_upper_right[0], point_upper_right[1])
    draw_line(point_upper_left[0], point_upper_left[1],
              point_bottom_left[0], point_bottom_left[1])
    draw_line(point_bottom_left[0], point_bottom_left[1],
              point_bottom_right[0], point_bottom_right[1])
...
def draw_diamond(x, y, side_length, angle):
    ...
    draw_line(point_upper[0], point_upper[1], point_left[0], point_left[1], isShow=0)
    draw_line(point_upper[0], point_upper[1], point_right[0], point_right[1], isShow=0)
    draw_line(point_bottom[0], point_bottom[1], point_left[0], point_left[1], isShow=0)
    draw_line(point_bottom[0], point_bottom[1], point_right[0], point_right[1], isShow=0)
...
if __name__ == '__main__':
    ...
    draw_rectangle(10, 40, 60, 20, 1, 1)
